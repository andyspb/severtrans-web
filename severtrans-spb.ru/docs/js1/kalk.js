...
if (document.getElementById('snds').checked)

var nd = parseFloat(document.getElementById('snds').value);

if (document.getElementById('nonds').checked)

var nd = parseFloat(document.getElementById('nonds').value);
